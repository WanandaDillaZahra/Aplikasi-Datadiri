...
<form action="login.php" method="POST" class="w-50 mx-auto">
    ...
    <input class="form-control" type="text" name="username" placeholder="Ex. wananda" />
    <br>
    <label>Password</label><br>
    <input class="form-control" type="password" name="password" placeholder="Ex. ---" />
    <br>
    <input class="form-control btn btn-sm btn-primary" type="submit" name="login" value="Masuk" />
</form>
